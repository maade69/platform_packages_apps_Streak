...
import com.streak.settings.preferences.ShortcutPickHelper;
import com.streak.settings.preferences.ActionPreference;
import com.streak.settings.preferences.CustomActionListAdapter;
...
public class ActionFragment extends SettingsPreferenceFragment implements
    ...
    public int getDialogMetricsCategory(int dialogId) {
        switch (dialogId) {
            case DIALOG_CATEGORY:
            case DIALOG_CUSTOM_ACTIONS:
                return MetricsEvent.STREAK_SETTINGS;
            default:
                return 0;
        }
    }
