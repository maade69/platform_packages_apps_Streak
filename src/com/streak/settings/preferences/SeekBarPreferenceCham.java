package com.streak.settings.preferences;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String STREAKSETTINGSNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, STREAKSETTINGSNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, STREAKSETTINGSNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(STREAKSETTINGSNS, "interval");
            if(newInterval != null)
